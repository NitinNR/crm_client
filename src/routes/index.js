    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        },
        {
          path: 'channels',
          children: [
            { element: <Navigate to="/dashboard/channels/channels-list" replace />, index: true },
            { path: 'channels-list', element: <ChannelApps /> },
          ],
        },
        {
          path: 'broadcast',
          children: [
            ...
            { path: 'schedule', element: <BroadcastList /> },
            { path: 'create', element: <BroadcastCreate /> },
            { path: ':id/edit', element: <BroadcastCreate /> },
          ],
        },
        {
          path: 'channel_broadcast',
          children: [
            // { element: <Navigate to="/dashboard/broadcast/schedule" replace />, index: true },
            { path: 'create', element: <BroadcastCreate2 /> },
...
// Broadcast
const BroadcastList = Loadable(lazy(() => import('../pages/broadcast/BroadcastList')));
const BroadcastCreate = Loadable(lazy(() => import('../pages/broadcast/BroadcastCreate')));
const BroadcastCreate2 = Loadable(lazy(() => import('../pages/broadcast_with_channel/BroadcastCreate2')));
const BroadcastEdit2 = Loadable(lazy(() => import('../pages/broadcast_with_channel/BroadcastEdit2')));
...
// Reports
const MessageReport = Loadable(lazy(() => import('../pages/report/MessageReport')));
