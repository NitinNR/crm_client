...
// sections
import BroadcastNewForm from './BroadcastEdit2';
// Services
...
// crm service
import { get_single_brodcast,createBroadcast,updateBroadcast,createBroadcast2 } from '../../services/broadcasts.service';
  ...
  return (
    <Page title={!isEdit ? 'Broadcast: Create' : 'Broadcast: Edit'}>
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        />
        <BroadcastNewForm userId={userId} spaceId={spaceId} bid={id} isEdit={isEdit} currentBroadcast={currentBroadcast} createBroadcast={createBroadcast} createBroadcast2={createBroadcast2} updateBroadcast={updateBroadcast} channels={channels} />
      </Container>
    </Page>
  );
}
